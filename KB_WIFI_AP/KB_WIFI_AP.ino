...
const String webpage = "<!DOCTYPE html>\n<html>  \n  <head>\n    <meta charset=\"utf-8\">\n\t<style>\n\t.myButton {\n\t\t-webkit-border-radius:18px;\n\t\t-moz-border-radius:18px;\n\t\tborder-radius:18px;\n\t\tdisplay:inline-block;\n\t\tcursor:pointer;\n\t\tcolor:#ffffff;\n\t\tfont-family:Arial;\n\t\tfont-size:20px;\n\t\tfont-weight:bold;\n\t\twidth:160px;\n\t\tpadding:20px 18px;\n\t\ttext-decoration:none;\n\t\ttext-shadow:2px 4px 0px #2f6627;\n\t\t}\n\t.myButton:hover {\n\t\tbackground-color:#5cbf2a;\n\t}\n\t.myButton:active {\n\t\tposition:relative;\n\t\ttop:1px;\n\t}\n\n  </style>\n  </head>\n  <body>\n    <table border=\"0\" cellpadding=\"1\" cellspacing=\"1\" style=\"width:100%\">\n\t\t<tbody>\n\t\t\t<tr>\n\t\t\t\t<td>&nbsp;</td>\n\t\t\t\t<td><a href=\"/forward\"><input class=\"myButton\" style=\"background-color:#44c767;\" name=\"btnForward\" type=\"button\" value=\"Forward\" /></a></td>\n\t\t\t\t<td>&nbsp;</td>\n\t\t\t\t<td>&nbsp;</td>\n\t\t\t\t<td>&nbsp;</td>\n\t\t\t\t<td>&nbsp;</td>\n\t\t\t</tr>\n\t\t\t<tr>\n\t\t\t\t<td><a href=\"/left\"><input class=\"myButton\" style=\"background-color:#f716f7;\" name=\"btnLeft\" type=\"button\" value=\"LEFT\" /></a></td>\n\t\t\t\t<td><a href=\"/stop\"><input class=\"myButton\" style=\"background-color:#e63b35;\" name=\"btnStop\" type=\"button\" value=\"STOP\" /></a></td>\n\t\t\t\t<td><a href=\"/right\"><input class=\"myButton\" style=\"background-color:#f716f7;\" name=\"btnRight\" type=\"button\" value=\"RIGHT\" /></a></td>\n\t\t\t\t<td>&nbsp;</td>\n\t\t\t\t<td><a href=\"/cmd1\"><input class=\"myButton\" style=\"background-color:#00b5b5;\" name=\"btnCommand1\" type=\"button\" value=\"COMMAND 1\" /></a></td>\n\t\t\t\t<td>&nbsp;</td>\n\t\t\t</tr>\n\t\t\t<tr>\n\t\t\t\t<td>&nbsp;</td>\n\t\t\t\t<td><a href=\"/backward\"><input class=\"myButton\" style=\"background-color:#44c767;\" name=\"btnBackward\" type=\"button\" value=\"Backward\" /></a></td>\n\t\t\t\t<td>&nbsp;</td>\n\t\t\t\t<td>&nbsp;</td>\n\t\t\t\t<td><a href=\"/cmd2\"><input class=\"myButton\" style=\"background-color:#3751fa;\" name=\"btnCommand2\" type=\"button\" value=\"COMMAND 2\" /></a></td>\n\t\t\t\t<td>&nbsp;</td>\n\t\t\t</tr>\n\t\t</tbody>\n\t</table>\n  </body>\n</html>\n\n\n";
